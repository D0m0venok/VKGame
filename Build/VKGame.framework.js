...
function _Handler(method, data, callback) {
 ...
 var AddCallback = function(data, callback) {
  ...
  VK.addCallback(data.eventName, eventCallbackHandler.bind({
   callbackId: data.callbackId
  }));
 };
 var RemoveCallback = function(data) {
  data = JSON.parse(data);
  VK.removeCallback(data.eventName, eventCallbackHandler.bind({
   callbackId: data.callbackId
  }));
 };
